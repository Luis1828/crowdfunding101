...
const SAMPLE_DATA = {
  categories: [
    {
      ...
      description: "Innovaciones tecnológicas y gadgets",
    },
    {
      id: 2,
      name: "Arte",
      icon: "fi fi-rr-palette",
      description: "Proyectos creativos y artísticos",
    },
    {
      id: 3,
      name: "Cine",
      icon: "fi fi-rr-film",
      description: "Películas y documentales",
    },
    {
      id: 4,
      name: "Música",
      icon: "fi fi-rr-music",
      description: "Álbumes y giras",
    },
    {
      id: 5,
      name: "Publicación",
  ...
  featuredProjects: [
    {
      id: 1,
      title: "SmartWatch Pro - El reloj del futuro",
      creator: "María González",
      category: "Tecnología",
      image: "assets/images/tech_startup.jpg",
      goal: 20000,
      raised: 15000,
      backers: 184,
      daysLeft: 15,
      description: "SmartWatch Pro es el reloj inteligente más avanzado.",
      status: PROJECT_STATUS.PUBLICADO,
      campaignStatus: CAMPAIGN_STATUS.EN_PROGRESO,
      creatorId: "user1",
      observations: "",
      donations: [
    ...
    {
      id: 2,
      title: "EcoBottle - Botella reutilizable inteligente",
      creator: "Carlos Ruiz",
      category: "Medio Ambiente",
      image: "assets/images/eco_project.jpg",
      goal: 10000,
      raised: 12500,
      backers: 210,
      daysLeft: 0,
      description: "Botella de agua que rastrea tu hidratación.",
      status: PROJECT_STATUS.PUBLICADO,
      campaignStatus: CAMPAIGN_STATUS.FINALIZADA,
      creatorId: "user2",
      observations: "",
      donations: [
    ...
    {
      id: 3,
      title: "Arte Abstracto: 'Universo Interior'",
      creator: "Ana López",
      category: "Arte",
      image: "assets/images/art_creative.jpg",
      goal: 10000,
      raised: 4500,
      backers: 67,
      daysLeft: 28,
      description: "Colección de pinturas abstractas.",
      status: PROJECT_STATUS.PUBLICADO,
      campaignStatus: CAMPAIGN_STATUS.EN_PROGRESO,
      creatorId: "user3",
      observations: "",
  ...
  allProjects: [
    {
      ...
      category: "Cine",
      image: "assets/images/nuevos/documental-amazonas.jpg",
      goal: 30000,
      raised: 18000,
      backers: 245,
      daysLeft: 42,
      description: "Documental sobre la riqueza cultural del Amazonas.",
      status: PROJECT_STATUS.PUBLICADO,
      campaignStatus: CAMPAIGN_STATUS.EN_PROGRESO,
      creatorId: "user4",
      observations: "",
    ...
    {
      id: 5,
      title: "Álbum: 'Sueños Electrónicos'",
      creator: "DJ Nova",
      category: "Música",
      image: "assets/images/music_campaign.jpg",
      goal: 10000,
      raised: 8500,
      backers: 120,
      daysLeft: 10,
      description: "Viaje sonoro de paisajes electrónicos.",
      donations: [
    ...
    {
      id: 6,
      title: "Libro: 'Fronteras de la Ciencia'",
      creator: "Dr. Elena Vargas",
      category: "Publicación",
      image: "assets/images/book_publication.jpg",
      goal: 10000,
      raised: 9500,
      backers: 189,
      daysLeft: 5,
      description: "Exploración de avances en física y AI.",
      donations: [
    ...
    {
      id: 7,
      title: "HealthApp - Tu salud en tus manos",
      creator: "Dr. Roberto Méndez",
      category: "Tecnología",
      image: "assets/images/nuevos/app-salud.jpg",
      goal: 25000,
      raised: 18200,
      backers: 312,
      daysLeft: 20,
      description:
        "Aplicación móvil para monitoreo de salud y bienestar personal con seguimiento de hábitos y recordatorios médicos.",
      donations: [
    ...
    {
      id: 8,
      title: "Colección: 'Expresiones Abstractas'",
      creator: "Ana Martínez",
      category: "Arte",
      image: "assets/images/nuevos/arte-abstracto.jpg",
      goal: 15000,
      raised: 11200,
      backers: 145,
      daysLeft: 35,
      description:
        "Serie de obras abstractas que exploran emociones y conceptos universales a través del color y la forma.",
      donations: [
    ...
    {
      id: 9,
      title: "AquaSmart - Botella inteligente conectada",
      creator: "Carlos Ruiz",
      category: "Medio Ambiente",
      image: "assets/images/nuevos/botella-inteligente.jpg",
      goal: 18000,
      raised: 14500,
      backers: 198,
      daysLeft: 25,
      description:
        "Botella reutilizable con tecnología IoT para rastrear hidratación y recordar beber agua.",
      donations: [
    ...
    {
      id: 10,
      title: "MasterClass DJ - Producción Musical Profesional",
      creator: "DJ Nova",
      category: "Música",
      image: "assets/images/nuevos/curso-dj.jpg",
      goal: 12000,
      raised: 9800,
      backers: 156,
      daysLeft: 18,
      description:
        "Curso completo de producción musical y técnicas de DJ para principiantes y avanzados.",
      donations: [
    ...
    {
      id: 11,
      title: "Amazonas: Voces de la Selva",
      creator: "Luis Fernández",
      category: "Cine",
      image: "assets/images/nuevos/voces-amazonas.jpg",
      goal: 35000,
      raised: 22100,
      backers: 287,
      daysLeft: 45,
      description:
        "Documental que muestra la riqueza cultural y natural del Amazonas y las comunidades indígenas.",
      donations: [
    ...
    {
      id: 12,
      title: "EcoSpace - Centro comunitario sostenible",
      creator: "María González",
      category: "Medio Ambiente",
      image: "assets/images/nuevos/espacio-ecologico.jpg",
      goal: 40000,
      raised: 28500,
      backers: 423,
      daysLeft: 30,
      description:
        "Espacio comunitario ecológico con paneles solares, huertos urbanos y áreas de reciclaje.",
      donations: [
    ...
    {
      id: 13,
      title: "Print3D Pro - Impresora 3D profesional",
      creator: "Ing. Pablo Rodríguez",
      category: "Tecnología",
      image: "assets/images/nuevos/gadget-impresion3d.jpg",
      goal: 22000,
      raised: 16800,
      backers: 234,
      daysLeft: 22,
      description:
        "Impresora 3D de alta precisión para uso profesional y educativo con materiales biodegradables.",
      donations: [
    ...
    {
      id: 14,
      title: "Estrategia Total - Juego de mesa estratégico",
      creator: "JuegoLab Studio",
      category: "Publicación",
      image: "assets/images/nuevos/juego-de-mesa.jpg",
      goal: 15000,
      raised: 12300,
      backers: 178,
      daysLeft: 28,
      description:
        "Juego de mesa estratégico para 2-6 jugadores con mecánicas innovadoras y diseño artístico.",
      donations: [
    ...
    {
      id: 15,
      title: "Ciencia Avanzada: Guía del Futuro",
      creator: "Dr. Elena Vargas",
      category: "Publicación",
      image: "assets/images/nuevos/libro-cientifico.jpg",
      goal: 14000,
      raised: 11200,
      backers: 167,
      daysLeft: 15,
      description:
        "Libro que explora los avances científicos más importantes del siglo XXI y sus implicaciones.",
      donations: [
    ...
    {
      id: 16,
      title: "EcoFashion - Moda sostenible y ética",
      creator: "Diseño Sostenible Co.",
      category: "Medio Ambiente",
      image: "assets/images/nuevos/moda-etica.jpg",
      goal: 28000,
      raised: 19500,
      backers: 312,
      daysLeft: 32,
      description:
        "Línea de ropa sostenible fabricada con materiales orgánicos y procesos de producción éticos.",
      donations: [
    ...
    {
      id: 17,
      title: "El Rincón Temático - Restaurante experiencial",
      creator: "Chef Roberto Méndez",
      category: "Publicación",
      image: "assets/images/nuevos/restaurante-tematico.jpg",
      goal: 32000,
      raised: 24100,
      backers: 389,
      daysLeft: 38,
      description:
        "Restaurante temático que ofrece experiencias culinarias únicas basadas en diferentes culturas del mundo.",
      donations: [
    ...
    {
      id: 18,
      title: "SmartGadget X - Dispositivo inteligente universal",
      creator: "Tech Innovations",
      category: "Tecnología",
      image: "assets/images/nuevos/smart-gadget.jpg",
      goal: 30000,
      raised: 22600,
      backers: 356,
      daysLeft: 27,
      description:
        "Gadget inteligente que se conecta con todos tus dispositivos para crear un ecosistema doméstico inteligente.",
      status: PROJECT_STATUS.PUBLICADO,
      campaignStatus: CAMPAIGN_STATUS.EN_PROGRESO,
      creatorId: "user1",
      observations: "",
    ...
    {
      id: 19,
      title: "Proyecto Nuevo - Esperando Revisión",
      creator: "María González",
      category: "Tecnología",
      image: "assets/images/tech_startup.jpg",
      goal: 15000,
      ...
      daysLeft: 30,
      description:
        "Este es un proyecto nuevo que está esperando revisión por parte del administrador.",
      status: PROJECT_STATUS.EN_REVISION,
    ...
    },
    {
      ...
      daysLeft: 45,
      description:
        "Este proyecto necesita algunas correcciones antes de ser publicado.",
      status: PROJECT_STATUS.OBSERVADO,
      campaignStatus: CAMPAIGN_STATUS.NO_INICIADA,
      creatorId: "user2",
      observations:
        "Falta información sobre el impacto ambiental. Por favor agregue más detalles sobre los materiales utilizados.",
      donations: [],
    },
    {
      id: 21,
      ...
      daysLeft: 0,
      description:
        "Este proyecto fue rechazado por no cumplir con los lineamientos de la plataforma.",
      status: PROJECT_STATUS.RECHAZADO,
      campaignStatus: CAMPAIGN_STATUS.NO_INICIADA,
      creatorId: "user3",
      observations:
        "El proyecto no cumple con los requisitos de contenido apropiado.",
      donations: [],
    },
    {
      id: 22,
      ...
      daysLeft: 60,
      description:
        "Este proyecto aún está en borrador y no ha sido enviado para revisión.",
      status: PROJECT_STATUS.BORRADOR,
      campaignStatus: CAMPAIGN_STATUS.NO_INICIADA,
      creatorId: "user4",
      observations: "",
      donations: [],
  ...
  faqs: [
    {
      ...
      answer:
        "Regístrate, verifica tu correo y crea tu proyecto desde el panel de usuario.",
    },
    {
      question: "¿Qué tipos de proyectos están permitidos?",
      answer:
        "Proyectos creativos e innovadores. No se permiten actividades ilegales o discriminación.",
    },
    {
      question: "¿Cómo funciona el proceso de financiación?",
      answer:
        "Si el proyecto alcanza la meta se entregan los fondos; si no, se devuelven.",
    },
    {
      question: "¿Qué comisiones cobra la plataforma?",
      answer:
        "Comisión de 5% sobre fondos recaudados con cargos por procesamiento.",
    },
  ],
  users: [
    {
...
function ensureProjectStatuses() {
  const allProjects = [
    ...SAMPLE_DATA.featuredProjects,
    ...SAMPLE_DATA.allProjects,
  ];
...
function loadFooterData() {
  ...
  if (phone) {
    ...
    phone.href = `tel:${CONFIG.contactPhone.replace(/\D/g, "")}`;
  }
  if (addr1 && addr2) {
